...
require File.join(File.dirname(__FILE__),"..","lib","aasm","lib","acts_as_state_machine.rb")
ActiveRecord::Base.extend ScottBarron::Acts::StateMachine::ActMacro
require File.join(File.dirname(__FILE__),"..","lib","EventAction","lib","event_action.rb")
ActiveRecord::Base.extend Antrapol::EventAction

# to facilite ActiveRecord conditions building
